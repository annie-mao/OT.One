...
c.add_container("2-8-tube-strip",2,8,0,9,0,0,20,5,300)
c.add_container("96-PCR-tubes",8,12,9,9,0,0,20,5,300)
c.add_container("tube-rack-600ul",4,6,19.5,19.5,0,0,30,6,650)
c.add_container("tube-rack-1.5ml",4,6,19.5,19.5,0,0,37,9,1700)
c.add_container("tube-strip-600ul",1,6,19.5,19.5,0,0,30,6,650)
c.add_container("tube-strip-1.5ml",1,6,19.5,19.5,0,0,37,9,1700)
c.add_container("tube-strip-2ml",4,6,19.5,19.5,0,0,34,9,2000)
