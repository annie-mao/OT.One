...
# cycler
pf.add_cycler_prog('A',4,2+60+15+10+2+15)
pf.add_cycler_prog('B',4,80)
pf.add_cycler_prog('C',4,47)
...
# transfer to cycler
pf.add_transfer_group(mm,c_tube,10)
...
pf.add_transfer_group(exo,c_tube,1.9,{'to':{'tip-offset':-5,'touch-tip':False}})

# second cycler instruction
pf.add_cycler_group('B')
...
pf.add_transfer_group(oligo2,c_tube,0.71,{'to':{'tip-offset':-5,'touch-tip':False}})

# third cycler instruction
pf.add_cycler_group('C')
